...
def send(item, path):
  ...
  computers. The S7 machine at Modane and the KIT 
  kalinka machine. This is because the CC in Lyon
  ...
  have been register with CC and are only valid for thos particular users. 
